...
ttk.Button(mainframe, text="Расчитать", command=calculate).grid(column=1, row=5, sticky=W)
label_res = ttk.Label(mainframe, text="ИМТ:").grid(column=1, row=3, sticky=(W, E))
